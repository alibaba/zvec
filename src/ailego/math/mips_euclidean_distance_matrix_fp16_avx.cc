...
float MipsEucldeanDistanceSphericalInjectionAVX(const Float16 *lhs, const Float16 *rhs, size_t size, float e2) {
  float u2{0.0f};
  float v2{0.0f};
  float sum{0.0f};
...
float MipsEucldeanDistanceRepeatedQuadraticInjectionAVX(const Float16 *lhs, const Float16 *rhs, size_t size, size_t m, float e2) {
  float u2{0.0f};
  float v2{0.0f};
  float sum{0.0f};
