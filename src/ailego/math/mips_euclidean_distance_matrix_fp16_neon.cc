...
// Baseline ARMv8 NEON path: convert FP16 lanes to FP32 before arithmetic.
// The native FEAT_FP16 variant lives in
// mips_euclidean_distance_matrix_fp16_neonfp16.cc, which is compiled with an
// FP16-capable -march and selected at runtime by the dispatcher.
