...
#if defined(__AVX2__)
float MipsEucldeanDistanceRepeatedQuadraticInjectionAVX2(const int8_t *lhs, const int8_t *rhs, size_t size, size_t m, float e2);
float MipsEucldeanDistanceSphericalInjectionAVX2(const int8_t *lhs, const int8_t *rhs, size_t size, float e2);
#endif

#if defined(__SSE4_1__)
float MipsEucldeanDistanceRepeatedQuadraticInjectionSSE(const int8_t *lhs, const int8_t *rhs, size_t size, size_t m, float e2);
float MipsEucldeanDistanceSphericalInjectionSSE(const int8_t *lhs, const int8_t *rhs, size_t size, float e2);
#endif
...
#if defined(__AVX2__)
  if (zvec::ailego::internal::CpuFeatures::static_flags_.AVX2) {
    *out = MipsEucldeanDistanceRepeatedQuadraticInjectionAVX2(p, q, dim, e2);
    return;
  } 
#endif
