...
void compute_one_to_many_squared_euclidean_avx512fp16_fp16_1(
    ...
    float *sums) {
  return compute_one_to_many_squared_euclidean_avx512fp16_fp16<ailego::Float16, 1>(
...
void compute_one_to_many_squared_euclidean_avx512fp16_fp16_12(
    ...
    float *sums) {
  return compute_one_to_many_squared_euclidean_avx512fp16_fp16<ailego::Float16, 12>(
      query, ptrs, prefetch_ptrs, dim, sums);
}
