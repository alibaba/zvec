...
void squared_euclidean_fp16_distance_sse(const void *a, const void *b,
...
void squared_euclidean_fp16_batch_distance_sse(const void *const *vectors,
...
void inner_product_fp16_distance_sse(const void *a, const void *b, size_t dim,
                                     float *distance) {
#if ZVEC_TURBO_SSE2
  *distance =
...
void inner_product_fp16_batch_distance_sse(const void *const *vectors,
                                           const void *query, size_t n,
                                           size_t dim, float *distances) {
#if ZVEC_TURBO_SSE2
...
void cosine_fp16_distance_sse(const void *a, const void *b, size_t dim,
                              float *distance) {
  inner_product_fp16_distance_sse(a, b, dim, distance);
#if ZVEC_TURBO_SSE2
  *distance += 1.0f;
#endif
}

void cosine_fp16_batch_distance_sse(const void *const *vectors,
                                    const void *query, size_t n, size_t dim,
                                    float *distances) {
  inner_product_fp16_batch_distance_sse(vectors, query, n, dim, distances);
#if ZVEC_TURBO_SSE2
