/*
 * Zvec C API — INT8 + Random Rotation Query Example
 * ====================================================
 *
 * Opens an INT8 + rotation enabled collection (built by int8_rotate_build.c),
 * runs vector searches, and evaluates recall against ground truth.
 *
 * The reformer auto-loads the rotation matrix from the stored index meta
 * during collection open, applying the same FhtKacRotator used at build time.
 *
 * Configuration:
 *   Collection : /root/data/cohere/1m/db/cohere_cosine_int8_rotate_c
 *   TopK       : 100
 ...
 *   make c_api_hnsw_int8_rotate_query
 *
 * Usage:
 *   ./c_api_hnsw_int8_rotate_query
 */
...
int main(void) {
    printf("============================================================\n");
    printf("  Zvec C API — INT8 + Rotate Query Example\n");
    printf("============================================================\n");
