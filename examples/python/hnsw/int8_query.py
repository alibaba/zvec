...
Opens an INT8 + rotation enabled collection (built by int8_build.py),
...
Configuration:
    Collection : /root/data/cohere/1m/db/cohere_cosine_int8
    TopK       : 100
...
COLLECTION_PATH = "/root/data/cohere/1m/db/cohere_cosine_int8"
...
def main() -> None:
    print("=" * 60)
    print("  Zvec Python API — INT8 + Query Example")
    print("=" * 60)
    ...
    result_file = "/tmp/int8_first_results.txt"
