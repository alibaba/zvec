"""
Zvec Python API — Vamana INT8 + Random Rotation Query Example
==============================================================

Opens a Vamana INT8 + rotation collection (built by int8_rotate_build.py),
...
Configuration:
    Collection : /root/data/cohere/1m/db/cohere_vamana_cosine_int8_rotate
    TopK       : 100
...
COLLECTION_PATH = "/root/data/cohere/1m/db/cohere_vamana_cosine_int8_rotate"
...
def main() -> None:
    print("=" * 60)
    print("  Zvec Python API — Vamana INT8 + Rotate Query Example")
    print("=" * 60)
    ...
    result_file = "/tmp/vamana_int8_rotate_first_results.txt"
    ...
    # ---- Step 6b: Compare with Vamana INT8 (no-rotate) ----
    int8_result_file = "/tmp/vamana_int8_first_results.txt"
    if os.path.exists(int8_result_file):
        print(f"\n[Step 6b] Comparing with Vamana INT8 (no-rotate) ...")
        ...
        print(f"\n[Step 6b] Vamana INT8 result file not found ({int8_result_file}),")
        print(f"          Run vamana/int8_query.py first to enable comparison.")
