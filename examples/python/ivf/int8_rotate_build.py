"""
Zvec Python API — IVF INT8 + Random Rotation Build Example
============================================================

Builds a zvec Collection with IVF index, INT8 quantization and random rotation
(IntegerStreamingConverter / CosineInt8Converter + FhtKacRotator) enabled.

The key configuration is:
    quantize_type=QuantizeType.INT8, enable_rotate=True

This triggers the C++ converter to:
...
Output: /root/data/cohere/1m/db/cohere_ivf_cosine_int8_rotate
...
COLLECTION_PATH = "/root/data/cohere/1m/db/cohere_ivf_cosine_int8_rotate"
...
def main() -> None:
    print("=" * 60)
    print("  Zvec Python API — IVF INT8 + Rotate Build Example")
    print("=" * 60)
    ...
    schema = zvec.CollectionSchema(
        name="cohere_ivf_cosine_int8_rotate",
        fields=[
            FieldSchema(
                "id",
                DataType.INT64,
    ...
    # ---- Step 5: Optimize (build IVF index with INT8 + rotation) ----
