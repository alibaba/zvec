"""
Zvec Python API — IVF INT8 Query Example
=========================================

Opens an IVF INT8 collection (built by int8_build.py),
runs vector searches, and evaluates recall against ground truth.

Configuration:
    Collection : /root/data/cohere/1m/db/cohere_ivf_cosine_int8
    TopK       : 100
...
QUERY_FILE = "/root/data/cohere/1m/cohere_test_vector_1m.1000.norm.random.txt"
...
def main() -> None:
    print("=" * 60)
    print("  Zvec Python API — IVF INT8 Query Example")
    print("=" * 60)
