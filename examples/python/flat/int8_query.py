"""
Zvec Python API — Flat INT8 Query Example
==========================================

Opens a Flat + INT8 collection (built by int8_build.py),
runs brute-force vector searches, and evaluates recall against ground truth.

Configuration:
    Collection : /root/data/cohere/1m/db/cohere_flat_cosine_int8
    TopK       : 100
...
COLLECTION_PATH = "/root/data/cohere/1m/db/cohere_flat_cosine_int8"
...
def main() -> None:
    print("=" * 60)
    print("  Zvec Python API — Flat INT8 Query Example")
    print("=" * 60)
    ...
    result_file = "/tmp/flat_int8_first_results.txt"
