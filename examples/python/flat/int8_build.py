"""
Zvec Python API — Flat INT8 Build Example
==========================================

Builds a zvec Collection with Flat (brute-force) index and INT8 quantization.

Input : /root/data/cohere/1m/cohere_train_vector_1m.norm.zvec.vecs
Output: /root/data/cohere/1m/db/cohere_flat_cosine_int8
...
def main() -> None:
    print("=" * 60)
    print("  Zvec Python API — Flat INT8 Build Example")
    print("=" * 60)
    ...
    # ---- Step 3: Create collection with Flat + INT8 ----
    ...
    # ---- Step 5: Optimize (build Flat index with INT8) ----
