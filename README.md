...
> [!IMPORTANT]
> 🔎 **v0.3.1** (Apr 17, 2026): Hotfix — relaxed collection path restrictions and fixed Windows cross-drive collection creation (`MakePath`). [Release notes](https://github.com/alibaba/zvec/releases/tag/v0.3.1)
