...
> 🚀 **v0.4.0 (May 9, 2026)**
>
> - **Dart/Flutter SDK**: Published the official [zvec](https://pub.dev/packages/zvec) Flutter package with FFI bindings. Supports Android (arm64-v8a) and iOS (arm64) — no manual native compilation required.
